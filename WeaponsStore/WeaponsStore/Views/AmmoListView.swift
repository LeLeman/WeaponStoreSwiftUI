...
struct AmmoListView: View {
    @State private var selectedAmmoIndex = 0
    ...
    var body: some View {
        ...
        NavigationView{
            ...
            ZStack{
                ...
                VStack{
                    Spacer()
                    Text ("Scroll in right Bullets to see more".uppercased())
                    ...
                    ScrollView(.horizontal, showsIndicators: false){
                        HStack(spacing: 10) {
                            ForEach(Ammo.ammoDemo) { ammo in
                                GeometryReader{ proxy in
                                    NavigationLink(destination: AmmoDetailsView(ammo: ammo)) {
                                        VStack{
...
struct AmmoListView_Previews: PreviewProvider {
